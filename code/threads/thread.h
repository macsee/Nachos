...
// Tabla de descriptores de archivos. La columna 1 representa el id_descriptor, 
// la columna 2 si es de tipo consola o file, y la columna 3 representa el estado (READ/WRITE).

enum ModoDescriptor { FD_R, FD_W, FD_RW };
...
public:
    Thread(const char* debugName, bool isJoinable = false, int prioridad = 0);	// initialize a Thread
